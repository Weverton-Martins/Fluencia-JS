...
*/
const my3FavoriteTVShows = ['Stranger Things', 'Aneis do Poder', 'Game of Thrones']
const setence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(', ')}`.replace(', G', ' e  G')
